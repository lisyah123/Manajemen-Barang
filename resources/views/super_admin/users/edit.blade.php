...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center mb-8 gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Perbarui data atau role untuk <span class="font-bold text-blue-600">{{ $user->name }}</span>.</p>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="pengguna" {{ old('role', $user->role) == 'pengguna' ? 'selected' : '' }}>Staff / Pengguna Biasa</option>
                    </select>
